...
class MainActivityNegocio : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(insignia) {
            binding.imgInsignia.setImageResource(R.drawable.imginsignia)
        } else {
       ...
       binding.imgInsignia.setOnClickListener(){ view ->
            view.performHapticFeedback(HapticFeedbackConstants.LONG_PRESS)
           if(binding.btnListo.text == "Listo") {
               val builder = android.app.AlertDialog.Builder(this)
               builder.setTitle("Insignia de negocio verificado")
               builder.setMessage("Este negocio ha sido verificado, haz uso de sus servicios y disfruta de un beneficio sorpresa")
               ...
               val builder = android.app.AlertDialog.Builder(this)
               builder.setTitle("Verified business badge")
               builder.setMessage("This business has been verified, make use of its services and enjoy a surprise benefit")
            ...
            binding.imgTranslate.setOnClickListener { view ->
                ...
                if(flag){
                    ...
                    englishTranslator.translate(descripcion)
                        ...
                        .addOnFailureListener { exception ->
                            Log.e("TRANSLATE", exception.message!!)
                            Toast.makeText(this, "Translation failed, wait until the language model is fully downloaded", Toast.LENGTH_SHORT).show()
                        }
